...
export default function BerandaClient() {
 ...
 apiFetch('/events?running=1').catch(() => null),
 ...
 {/* 1.5 PROMO BANNERS */}
 <AdBanner placement="beranda" className="pt-4 pb-8" />
 ...
 <Link href="/leaderboard" className="text-xs font-black text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:text-indigo-400/80 shrink-0 bg-indigo-50 dark:bg-indigo-500/10 px-3 py-1.5 rounded-xl border border-indigo-100 dark:border-indigo-500/20">
 Lihat Semua
 </Link>
 </div>
 ...
 <div className="text-center py-6 text-xs font-semibold text-slate-400 dark:text-slate-400 w-full flex flex-col items-center gap-2">
 <Trophy className="text-slate-300 dark:text-slate-500" size={24} />
 ...
 {/* 3. KEUNGGULAN AMANIA */}
 <section className="bg-white dark:bg-slate-800 dark:bg-slate-900/80 border-y border-slate-200 dark:border-slate-700/80 dark:border-slate-800 py-16 md:py-20 mt-10 w-full relative">
 ...
 <h2 className="text-3xl md:text-4xl font-black text-slate-950 dark:text-white dark:text-white mb-4 tracking-tight">
 Kenapa Belajar di Amania?
 </h2>
 <p className="text-slate-500 dark:text-slate-400 font-medium text-sm md:text-base leading-relaxed">Kami merancang platform belajar IT modern dengan kurikulum adaptif guna memastikan akselerasi karir Anda.</p>
 </div>

 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
 {[
 { icon: Star, color:"text-amber-500", bg:"bg-amber-50 dark:bg-amber-500/10/80 dark:bg-amber-500/10 border-amber-100 dark:border-amber-500/20", title:"Mentor Praktisi", desc:"Belajar langsung dari pakar industri terkemuka dengan sesi interaktif."},
 { icon: ShieldCheck, color:"text-emerald-500", bg:"bg-emerald-50 dark:bg-emerald-500/10/80 dark:bg-emerald-500/10 border-emerald-100 dark:border-emerald-500/20", title:"Sertifikat Sah", desc:"Dapatkan e-certificate resmi untuk melengkapi kredibilitas portofolio Anda."},
 { icon: PlayCircle, color:"text-blue-500", bg:"bg-blue-50 dark:bg-blue-500/10/80 dark:bg-blue-500/10 border-blue-100 dark:border-blue-800", title:"Akses Rekaman", desc:"Nikmati akses lifetime pemutaran ulang video materi kelas kapan pun."},
 { icon: Users, color:"text-purple-500", bg:"bg-purple-50 dark:bg-purple-950/50/80 dark:bg-purple-950/50 border-purple-100 dark:border-purple-800", title:"Jejaring Luas", desc:"Bergabung ke forum diskusi alumni eksklusif bersama para pegiat IT."},
 ].map((item, idx) => (
 <div key={idx} className="bg-slate-50 dark:bg-[#111827] border border-slate-100 dark:border-slate-700/50/60 dark:border-slate-700 rounded-[2.2rem] p-8 text-center hover:bg-white dark:hover:bg-slate-700 dark:bg-slate-800 dark:hover:bg-slate-800 hover:shadow-2xl dark:shadow-black/25 hover:shadow-indigo-500/5 dark:hover:shadow-none hover:-translate-y-1.5 transition-transform duration-300 w-full group">
 <div className={`w-16 h-16 ${item.bg} ${item.color} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-sm dark:shadow-black/10 border shrink-0 group-hover:scale-110 transition-transform duration-300`}>
 <item.icon size={28} className="shrink-0"/>
 </div>
 <h3 className="text-lg font-black text-slate-900 dark:text-white mb-2.5">{item.title}</h3>
 ...
 <p className="text-slate-500 dark:text-slate-400 font-medium text-sm md:text-base leading-relaxed break-words w-full">Daftar kelas dan webinar yang sedang berlangsung atau segera dimulai. Jangan lewatkan!</p>
 </div>
 <Link href="/events" className="inline-flex items-center justify-center gap-1.5 text-indigo-600 dark:text-indigo-400 font-bold hover:text-indigo-800 dark:hover:text-indigo-300 bg-indigo-50 dark:bg-indigo-500/10 hover:bg-indigo-100 dark:hover:bg-indigo-900 px-6 py-3.5 rounded-2xl border border-indigo-100 dark:border-indigo-500/20 shrink-0 min-w-0 text-sm">
 ...
 <span className="bg-indigo-600 text-white px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg dark:shadow-black/20 shadow-indigo-500/20 flex items-center gap-1.5 border border-indigo-500/20">
 <Clock size={12} />
 ...
 <div className="flex items-center justify-between mb-3 text-slate-400 dark:text-slate-400 font-semibold text-[11px] uppercase tracking-wider">
 <span>Amania Academy</span>
 {event.venue && <span className="truncate max-w-[60%]">📍 {event.venue}</span>}
 </div>

 <h3 className="text-xl font-extrabold text-slate-950 dark:text-white dark:text-white leading-snug mb-5 line-clamp-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 break-words w-full">{event.title}</h3>

 <div className="mt-auto space-y-4 min-w-0 w-full border-t border-slate-100 dark:border-slate-700/50 dark:border-slate-700 pt-4">
 {/* Date Row */}
 <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-400 dark:text-slate-300 font-bold bg-slate-50 dark:bg-[#111827] px-4 py-3 rounded-xl border border-slate-100 dark:border-slate-700/50/60 dark:border-slate-700 min-w-0 w-full">
 ...
 {hasPrice && (
 <span className="text-xs text-slate-400 dark:text-slate-400 line-through font-bold">
 {formatRupiah(event.basic_price * 5)}
 </span>
 )}
 <span className={`text-lg font-black tracking-tight ${isFree ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-950 dark:text-white dark:text-white'}`}>
 ...
 <div className="bg-white dark:bg-[#111827] p-16 rounded-[3rem] border border-slate-200 dark:border-slate-700/50 flex flex-col items-center justify-center text-center shadow-lg dark:shadow-black/20 shadow-slate-100/30 dark:shadow-none w-full">
 <div className="w-24 h-24 bg-rose-50 dark:bg-rose-500/10 text-rose-300 dark:text-rose-500 rounded-[2rem] flex items-center justify-center mb-6 shadow-sm dark:shadow-black/10 border border-rose-100 dark:border-rose-800/30 dark:border-rose-800">
 <Calendar size={44} />
 </div>
 <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-2.5">Belum Ada Event Aktif</h3>
 <p className="text-slate-500 dark:text-slate-400 font-medium max-w-md">Saat ini belum ada kelas atau webinar yang sedang aktif. Kami sedang menyusun agenda baru, silakan kunjungi katalog berkala.</p>
 </div>
 )}
 </section>

 {/* 🔥 5. E-PRODUK TERLARIS 🔥 */}
 <section className="bg-slate-50 dark:bg-slate-800/60 dark:bg-slate-900/60 border-t border-slate-200 dark:border-slate-700/80 dark:border-slate-800 py-16 md:py-20 w-full min-w-0 relative">
 ...
 <p className="text-slate-500 dark:text-slate-400 font-medium text-sm md:text-base leading-relaxed break-words w-full">Koleksi e-book, source-code template, dan aset premium terlaris hasil rancangan kreator andalan.</p>
 </div>
 <Link href="/e-products" className="inline-flex items-center justify-center gap-1.5 text-indigo-600 dark:text-indigo-400 font-bold hover:text-indigo-800 dark:hover:text-indigo-300 bg-white dark:bg-[#111827] hover:bg-slate-50 dark:hover:bg-slate-700/50 dark:bg-slate-800/60 dark:hover:bg-slate-700 px-6 py-3.5 rounded-2xl border border-slate-200 dark:border-slate-700/50 shadow-xl dark:shadow-black/20 shadow-slate-100/50 dark:shadow-none shrink-0 min-w-0 text-sm">
 ...
 {isFree ? (
 <span className="bg-emerald-50 dark:bg-emerald-500 text-white px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest shadow-md dark:shadow-black/15">
 Gratis
 </span>
 ) : (
 <span className="bg-red-500 text-white px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest shadow-md dark:shadow-black/15">
 80% OFF
 </span>
 )}
 {isHot && !isFree && (
 <span className="bg-amber-50 dark:bg-amber-500 text-slate-900 dark:text-slate-100 px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest shadow-md dark:shadow-black/15 flex items-center gap-1">
 ...
 <p className="text-[10px] md:text-[11px] text-slate-400 dark:text-slate-400 font-bold uppercase tracking-wider truncate mb-1 w-full" title={product.author?.name}>
 ...
 <div className="bg-white dark:bg-[#111827] p-16 rounded-[3rem] border border-slate-200 dark:border-slate-700/50 flex flex-col items-center justify-center text-center shadow-lg dark:shadow-black/20 shadow-slate-100/30 dark:shadow-none w-full">
 <div className="w-24 h-24 bg-slate-50 dark:bg-slate-800/60 dark:bg-slate-700 text-slate-300 dark:text-slate-400 rounded-[2rem] flex items-center justify-center mb-6 shadow-sm dark:shadow-black/10 border border-slate-100 dark:border-slate-700/50/30 dark:border-slate-600">
 <FileText size={44} />
 </div>
 <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-2.5">Belum Ada E-Produk</h3>
 <p className="text-slate-500 dark:text-slate-400 font-medium">Aset digital premium sedang disiapkan untuk Anda. Segera kembali!</p>
 </div>
 )}
 </div>
 </section>
 ...
 <section className="bg-white dark:bg-slate-800 dark:bg-slate-900/80 border-t border-slate-200 dark:border-slate-700/80 dark:border-slate-800 py-16 md:py-20 w-full min-w-0 relative">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full min-w-0">
 <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 text-center md:text-left w-full min-w-0">
 <div className="min-w-0 w-full">
 <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-indigo-50 dark:bg-indigo-500/10 rounded-full text-indigo-600 dark:text-indigo-400 text-xs font-extrabold uppercase tracking-wider mb-4 border border-indigo-100 dark:border-indigo-500/20">
 <Newspaper size={12} className="text-indigo-500 dark:text-indigo-400"/>
 ...
 <p className="text-slate-500 dark:text-slate-400 font-medium text-sm md:text-base leading-relaxed break-words w-full">Perluas cakrawala pengetahuan Anda dengan artikel inspiratif dan tren programming dari tim editorial Amania.</p>
 </div>
 <Link href="/articles" className="inline-flex items-center justify-center gap-1.5 text-indigo-600 dark:text-indigo-400 font-bold hover:text-indigo-800 dark:hover:text-indigo-300 shrink-0 min-w-0 text-sm bg-indigo-50 dark:bg-indigo-500/10 hover:bg-indigo-100 dark:hover:bg-indigo-900 border border-indigo-100 dark:border-indigo-500/20 px-6 py-3.5 rounded-2xl">
 ...
 <span className="inline-flex items-center gap-1.5 text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest mb-3 bg-indigo-50 dark:bg-indigo-500/10 px-2.5 py-1 rounded-lg border border-indigo-100 dark:border-indigo-500/20">
 {article.category?.name || 'Edukasi IT'}
 </span>
 <h3 className="text-xl font-extrabold text-slate-950 dark:text-white dark:text-white leading-snug line-clamp-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 break-words w-full">{article.title}</h3>
 </div>
 </Link>
 ))}
 </div>
 ) : (
 <div className="bg-slate-50 dark:bg-[#111827] p-16 rounded-[3rem] border border-slate-200 dark:border-slate-700/50 flex flex-col items-center justify-center text-center shadow-inner dark:shadow-none w-full">
 <div className="w-24 h-24 bg-white dark:bg-slate-800 dark:bg-slate-700 text-slate-300 dark:text-slate-400 rounded-[2rem] flex items-center justify-center mb-6 shadow-sm dark:shadow-black/10">
 <Newspaper size={44} />
 </div>
 <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-2.5">Belum Ada Artikel</h3>
 <p className="text-slate-500 dark:text-slate-400 font-medium">Tim redaksi sedang memformulasikan info & tips IT terbaik untuk Anda. Tunggu ya!</p>
 </div>
 )}
 </div>
 </section>
 ...
 <Link href="/community" className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 dark:text-white rounded-2xl font-black transition-transform hover:scale-105 active:scale-95 shadow-xl dark:shadow-black/20 shadow-amber-400/20 w-full lg:w-auto min-w-0">
