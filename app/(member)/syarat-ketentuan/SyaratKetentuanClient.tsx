...
export default function SyaratKetentuanClient() {
 ...
 <h2 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-indigo-600 dark:text-indigo-400 tracking-tight">1. Penerimaan Syarat</h2>
 ...
 <h2 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-indigo-600 dark:text-indigo-400 tracking-tight">2. Pendaftaran & Autentikasi Akun</h2>
 <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-sm md:text-base font-medium">
 ...
 <h2 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white mb-4 group-hover:text-indigo-600 dark:text-indigo-400 tracking-tight">3. Kebijakan Pembelian & Pembayaran</h2>
 ...
 <motion.section variants={fadeInUp} className="relative pl-8 md:pl-12 pb-12 border-l-2 border-slate-100 dark:border-slate-700/50 last:border-0 last:pb-0 group">
 <div className="absolute left-[-17px] top-0 w-8 h-8 bg-slate-50 dark:bg-[#111827] border-2 border-slate-200 dark:border-slate-700/50 text-slate-400 dark:text-slate-400 rounded-full flex items-center justify-center group-hover:bg-rose-50 dark:bg-rose-500 group-hover:text-white group-hover:border-rose-500 transition-transform duration-300 shadow-sm dark:shadow-black/10 z-10">
 <RefreshCcw size={14} />
 </div>
 <h2 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white mb-4 group-hover:text-rose-600 dark:text-rose-400 tracking-tight">4. Kebijakan Pengembalian Dana (Refund)</h2>
 <div className="bg-rose-50 dark:bg-rose-500/10 border border-rose-100 dark:border-rose-500/20 p-5 md:p-6 rounded-2xl text-rose-800 dark:text-rose-300 text-sm md:text-base font-medium leading-relaxed flex gap-4 items-start">
 ...
 <h2 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-indigo-600 dark:text-indigo-400 tracking-tight">5. Hak Kekayaan Intelektual</h2>
 <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-sm md:text-base font-medium">
