...
const EventSkeleton = () => (
 ...
 <div className="w-full aspect-[4/3] bg-slate-100 dark:bg-slate-700/50 animate-pulse shrink-0"/>
 <div className="p-5 sm:p-6 space-y-4 flex-1 flex flex-col">
 <div className="flex gap-2">
 <div className="h-5 w-1/3 bg-slate-100 dark:bg-slate-700/50 animate-pulse rounded-md"/>
 <div className="h-5 w-1/4 bg-slate-100 dark:bg-slate-700/50 animate-pulse rounded-md"/>
 </div>
 <div className="space-y-2">
 <div className="h-7 w-full bg-slate-200 dark:bg-slate-700/50 animate-pulse rounded-md"/>
 <div className="h-7 w-2/3 bg-slate-200 dark:bg-slate-700/50 animate-pulse rounded-md"/>
 </div>
 <div className="pt-4 mt-auto flex gap-3 w-full border-t border-slate-50 dark:border-slate-700/30">
 <div className="h-14 flex-1 bg-slate-100 dark:bg-slate-700/50 animate-pulse rounded-xl"/>
 <div className="h-14 flex-1 bg-slate-100 dark:bg-slate-700/50 animate-pulse rounded-xl"/>
 </div>
 </div>
 </div>
...
export default function EventsClient() {
 ...
 <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white via-slate-200 to-slate-400 tracking-tight leading-[1.1] drop-shadow-sm dark:shadow-black/10">
 ...
 <div className="relative flex flex-col sm:flex-row items-center bg-[#18181b]/80 backdrop-blur-2xl rounded-2xl p-2 border border-slate-200/30 dark:border-slate-700/20 shadow-[0_8px_32px_rgba(0,0,0,0.4)] focus-within:bg-[#18181b] focus-within:border-amber-400/30 transition-transform duration-500 w-full gap-2 sm:gap-0">
 <div className="hidden sm:block pl-5 pr-3 text-slate-400 group-focus-within:text-amber-400">
 ...
 className="w-full bg-transparent border-none text-white placeholder:text-slate-500 dark:text-slate-400 py-3 sm:py-3.5 px-4 sm:px-0 text-sm md:text-base font-medium outline-none min-w-0 text-center sm:text-left"
 />
 <button className="w-full sm:w-auto bg-gradient-to-r from-amber-400 to-orange-500 text-slate-950 dark:text-white px-8 py-3.5 sm:py-4 rounded-xl font-black text-sm hover:from-amber-300 hover:to-orange-400 transition-transform shadow-[0_0_20px_rgba(251,191,36,0.2)] shrink-0 active:scale-95 sm:ml-2 flex justify-center items-center gap-2">
 ...
 className={`group relative px-5 py-2.5 md:py-3 rounded-xl text-[11px] md:text-xs font-bold uppercase tracking-wider transition-transform whitespace-nowrap ${filter === tab.id ? 'text-white shadow-sm dark:shadow-black/10' : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white dark:text-slate-100 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-700 dark:bg-slate-700/50 dark:hover:bg-slate-700/50'}`}
 >
 {filter === tab.id && (
 <motion.div 
 ...
 <div className="text-xs md:text-sm font-semibold text-slate-500 dark:text-slate-400 bg-white dark:bg-[#111827] px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700/50 shadow-sm dark:shadow-black/10">
 ...
 {error ? (
 <div className="py-20 text-center bg-white dark:bg-[#111827] rounded-[24px] border border-rose-100 dark:border-rose-500/20 max-w-2xl mx-auto px-6 shadow-sm dark:shadow-black/10">
 ...
 <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="py-28 text-center bg-white dark:bg-[#111827] rounded-[2rem] border border-slate-200 dark:border-slate-700/50 px-6 shadow-sm dark:shadow-black/10">
 ...
 className="group flex flex-col h-full bg-white dark:bg-[#111827] rounded-[2rem] border border-slate-200 dark:border-slate-700/50 hover:border-indigo-400 overflow-hidden hover:shadow-[0_20px_40px_-15px_rgba(79,70,229,0.15)] transition-transform duration-500 hover:-translate-y-1 relative"
 >
 ...
 <div className="relative w-full aspect-[4/3] bg-slate-900 overflow-hidden shrink-0 flex items-center justify-center border-b border-slate-100 dark:border-slate-700/50">
 
 <div className="absolute top-4 left-4 right-4 flex justify-between items-start z-20">
 {/* Kiri - Status Event/Sisa Kuota */}
 <div className="flex flex-col gap-2 items-start">
 {isPast ? (
 <span className="bg-slate-900/80 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-xl shadow-sm dark:shadow-black/10 border border-slate-700 flex items-center gap-1.5">
 <CheckCircle2 size={12} /> Selesai
 </span>
 ) : event.quota === 0 ? (
 <span className="bg-rose-600/90 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-xl shadow-sm dark:shadow-black/10 border border-rose-500 flex items-center gap-1.5">
 <AlertCircle size={12} /> Penuh
 </span>
 ) : event.quota <= 15 ? (
 <motion.span animate={{ opacity: [1, 0.8, 1] }} transition={{ repeat: Infinity, duration: 2 }} className="bg-amber-50 dark:bg-amber-500/95 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-xl shadow-sm dark:shadow-black/10 border border-amber-400 flex items-center gap-1.5">
 <Zap size={12} className="fill-white"/> Sisa {event.quota}
 </motion.span>
 ) : (
 <span className="bg-white dark:bg-slate-800/90 backdrop-blur-md text-slate-800 dark:text-slate-200 text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-xl shadow-sm dark:shadow-black/10 border border-slate-200/50 dark:border-slate-700/300 flex items-center gap-1.5">
 <span className="relative flex h-2 w-2">
 <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
 <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-50 dark:bg-emerald-500"></span>
 </span>
 Buka
 </span>
 )}
 ...
 {/* Kanan - Info Waktu */}
 {timeLeft && !isPast && (
 <div className="bg-slate-900/80 backdrop-blur-md text-slate-100 text-[9px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-xl shadow-sm dark:shadow-black/10 border border-slate-700 flex items-center gap-1.5">
 ...
 <div className={`flex-1 rounded-xl p-2.5 border flex flex-col justify-center transition-transform ${isFree ? 'bg-emerald-50 dark:bg-emerald-500/10 border-emerald-100 dark:border-emerald-500/20' : 'bg-slate-50 dark:bg-[#111827] border-slate-100 dark:border-slate-700/50'}`}>
 ...
 <div className="flex-1 rounded-xl p-2.5 border border-amber-200/60 bg-gradient-to-br from-amber-50 to-orange-50 flex flex-col justify-center relative overflow-hidden group-hover:shadow-inner transition-transform">
 ...
 <div className="w-full bg-slate-900 text-white text-[11px] md:text-xs font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 group-hover:bg-indigo-600 shadow-sm dark:shadow-black/10">
 ...
 <div className="flex items-center gap-1 p-1.5 bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-700/50 rounded-2xl shadow-sm dark:shadow-black/10">
 <button onClick={() => handlePageChange(currentPage - 1)} disabled={currentPage === 1} className="w-10 h-10 flex items-center justify-center rounded-xl text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 dark:bg-slate-700/50 dark:hover:bg-slate-700/50 disabled:opacity-30 disabled:pointer-events-none transition-transform">
 <ChevronLeft size={18} strokeWidth={2.5} />
 </button>
 <div className="flex items-center gap-1 px-1">
 {[...Array(totalPages)].map((_, i) => (
 <button key={i} onClick={() => handlePageChange(i + 1)} className={`w-10 h-10 flex items-center justify-center rounded-xl text-sm font-bold transition-transform ${currentPage === i + 1 ? 'bg-indigo-600 text-white shadow-md dark:shadow-black/15 shadow-indigo-600/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 dark:bg-slate-700/50 dark:hover:bg-slate-700/50'}`}>
 {i + 1}
 </button>
 ))}
 </div>
 <button onClick={() => handlePageChange(currentPage + 1)} disabled={currentPage === totalPages} className="w-10 h-10 flex items-center justify-center rounded-xl text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 dark:bg-slate-700/50 dark:hover:bg-slate-700/50 disabled:opacity-30 disabled:pointer-events-none transition-transform">
