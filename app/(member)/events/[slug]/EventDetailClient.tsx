...
export default function EventDetailClient({ slug }: { slug: string }) {
 ...
 <Link
 href="/events"
 className="px-8 py-3.5 bg-slate-900 text-white rounded-xl font-bold hover:bg-indigo-600 shadow-lg dark:shadow-black/20"
 >
 Kembali ke Katalog
 </Link>
 </div>
 ...
 >
 <div className="p-1.5 bg-slate-100 dark:bg-slate-700/50 rounded-full group-hover:bg-indigo-100 dark:hover:bg-indigo-900 transition-transform">
 <ArrowLeft size={16} />
 </div>
 ...
 <div className="relative aspect-square sm:aspect-[21/9] w-full overflow-hidden sm:rounded-[2.5rem] shadow-2xl dark:shadow-black/25 group bg-slate-900">
 {eventData.image ? (
 <img
 ...
 <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.15] tracking-tight drop-shadow-2xl dark:shadow-black/25">
 {eventData.title}
 </h1>
 </motion.div>
 </div>
 ...
 <div className="bg-white dark:bg-[#111827] p-4 sm:p-5 rounded-[1.5rem] border border-slate-200 dark:border-slate-700/50 shadow-sm dark:shadow-black/10 flex flex-col gap-1.5">
 ...
 <div className="bg-white dark:bg-[#111827] p-4 sm:p-5 rounded-[1.5rem] border border-slate-200 dark:border-slate-700/50 shadow-sm dark:shadow-black/10 flex flex-col gap-1.5 sm:col-span-2 md:col-span-1">
 ...
 {/* Tab Content */}
 <div className="bg-white dark:bg-[#111827] rounded-[2rem] border border-slate-200 dark:border-slate-700/50 shadow-sm dark:shadow-black/10 p-5 sm:p-8 w-full">
 ...
 className={`pb-4 text-sm font-black transition-transform relative whitespace-nowrap px-1 ${
 activeTab === tab ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-400 dark:text-slate-400 hover:text-slate-700 dark:text-slate-300'
 }`}
 >
 ...
 alt={spk.name}
 className="w-14 h-14 rounded-full object-cover shadow-sm dark:shadow-black/10 group-hover:scale-105 transition-transform shrink-0 bg-slate-200"
 />
 ...
 <div
 key={i}
 className="flex items-center gap-4 p-5 bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-700/50 rounded-3xl hover:border-indigo-600 transition-transform group"
 >
 <div className="w-12 h-12 rounded-2xl bg-slate-50 dark:bg-[#111827] flex items-center justify-center text-slate-400 dark:text-slate-400 group-hover:bg-indigo-50 dark:hover:bg-indigo-500/10 group-hover:text-indigo-600 dark:text-indigo-400 transition-transform shrink-0">
 ...
 <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-700/50 rounded-[2.5rem] p-6 sm:p-8 shadow-2xl dark:shadow-black/25 shadow-slate-200 dark:shadow-none relative overflow-hidden">
 <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-50 dark:bg-indigo-500/10 rounded-bl-full -z-10 opacity-50"/>

 {/* WIDGET WAKTU TERSISA (Hitung Mundur) */}
 {timeLeft && !isPast && (
 <div className="mb-6 w-full flex items-center justify-between p-3.5 sm:p-4 rounded-2xl border bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200 shadow-sm dark:shadow-black/10 relative overflow-hidden group">
 <div className="absolute top-0 right-0 w-20 h-20 bg-amber-400/20 rounded-bl-full -z-10 blur-xl transition-transform duration-500"/>
 <div className="flex items-center gap-3 z-10">
 <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-gradient-to-br from-amber-400 to-orange-500 text-white shadow-md dark:shadow-black/15">
 <Clock size={18} />
 </div>
 <div>
 ...
 <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${selectedTier === 'basic' ? 'border-indigo-600 bg-indigo-600' : 'border-slate-300 dark:border-slate-600'}`}>
 ...
 className={`w-full py-4 rounded-xl font-black text-sm transition-transform shadow-xl dark:shadow-black/20 active:scale-[0.98] ${
 isPast || eventData.quota === 0
 ? 'bg-slate-200 text-slate-500 dark:text-slate-400 shadow-none cursor-not-allowed'
 : selectedTier === 'premium'
 ...
 {/* MOBILE BOTTOM BAR */}
 <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-800/95 backdrop-blur-xl border-t border-slate-100 dark:border-slate-700/50 p-4 pb-safe z-[40] lg:hidden shadow-[0_-10px_40px_rgba(0,0,0,0.08)] flex items-center justify-between gap-3">
 ...
 selectedTier === 'premium' ? 'text-amber-600' : isFree ? 'text-emerald-500' : 'text-slate-900 dark:text-white'
 }`}
 >
 {selectedTier === 'premium'
 ? `Rp ${eventData.premium_price.toLocaleString('id-ID')}`
 ...
 className={`flex-1 py-3.5 sm:py-4 rounded-xl font-black text-white text-xs sm:text-sm shadow-xl dark:shadow-black/20 flex items-center justify-center gap-1.5 transition-transform active:scale-95 ${
 eventData.quota === 0 || isPast
 ? 'bg-slate-200 text-slate-400 dark:text-slate-400 shadow-none'
 : selectedTier === 'premium'
 ...
 className="relative w-full max-w-[400px] bg-white dark:bg-[#111827] rounded-[2rem] shadow-2xl dark:shadow-black/25 p-6 md:p-8 overflow-hidden z-10"
 >
 {modalType === 'login' ? (
 <div className="text-center">
 <div className="w-20 h-20 bg-rose-50 dark:bg-rose-500/10 border border-rose-100 dark:border-rose-500/20 text-rose-500 rounded-full flex items-center justify-center mx-auto mb-5 shadow-sm dark:shadow-black/10">
 <Lock size={32} />
 </div>
 ...
 className="flex-1 py-3.5 bg-indigo-600 text-white rounded-xl font-bold text-sm hover:bg-indigo-700 shadow-lg dark:shadow-black/20 shadow-indigo-200 dark:shadow-indigo-900/30 transition-transform active:scale-95"
 >
 Login Sekarang
 </button>
 </div>
 ...
 <div className="text-center">
 <div className="w-20 h-20 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 text-emerald-500 rounded-full flex items-center justify-center mx-auto mb-5 shadow-sm dark:shadow-black/10">
 <ShieldCheck size={32} />
 </div>
 ...
 <Link 
 href={`/my-events/${slug}`} 
 className="flex-1 py-3.5 bg-indigo-600 text-white rounded-xl font-bold text-sm hover:bg-indigo-700 shadow-lg dark:shadow-black/20 shadow-indigo-200 dark:shadow-indigo-900/30 flex items-center justify-center transition-transform active:scale-95"
 >
 Buka Kelas
 </Link>
 </div>
