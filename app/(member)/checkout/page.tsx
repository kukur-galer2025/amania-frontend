...
export default function CheckoutPage() {
 ...
 <Suspense fallback={
 <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B1120] flex flex-col items-center justify-center gap-4">
 <Loader2 size={32} className="text-indigo-600 animate-spin"/>
 <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Mempersiapkan jalur aman Amania...</span>
 </div>
 }>
 <CheckoutClient />
 </Suspense>
