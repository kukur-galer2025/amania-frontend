...
export default async function ReadArticlePage({ params }: Props) {
 ...
 return (
 <Suspense fallback={
 <div className="min-h-screen bg-white dark:bg-slate-800 flex flex-col items-center justify-center gap-4">
 <Loader2 size={32} className="animate-spin text-blue-600"/>
 <p className="text-slate-500 dark:text-slate-400 font-medium text-sm">Menyiapkan halaman...</p>
 </div>
 }>
