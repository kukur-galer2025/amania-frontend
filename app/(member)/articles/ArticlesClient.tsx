...
export default function ArticlesClient() {
 ...
 className={`whitespace-nowrap text-xs md:text-sm font-bold uppercase tracking-wider shrink-0 ${
 ...
 className={`w-8 h-8 md:w-10 md:h-10 shrink-0 flex items-center justify-center text-xs md:text-sm font-bold rounded-md md:rounded-none ${
 currentPage === i + 1 
