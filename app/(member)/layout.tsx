...
export default function MemberLayout({ children }: { children: React.ReactNode }) {
 ...
 >
 <div className="absolute inset-0 bg-[#25D366] rounded-full blur-xl opacity-20 group-hover:opacity-50 group-hover:scale-150 transition-transform duration-500"></div>
