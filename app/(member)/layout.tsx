...
export default function MemberLayout({ children }: { children: React.ReactNode }) {
 ...
 return (
 <Link href={href} className={`flex items-center justify-between px-3.5 py-2.5 rounded-xl group relative overflow-hidden ${isActive ? 'bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-700/50 text-indigo-700 dark:text-indigo-400 shadow-[0_2px_15px_-3px_rgba(79,70,229,0.1)] dark:shadow-none' : 'border border-transparent text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700/50 hover:text-slate-800 dark:hover:text-slate-200'}`}>
 ...
 {isActive && <motion.div layoutId="activeNav" className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-indigo-600 dark:bg-indigo-400 rounded-r-full shadow-[0_0_8px_rgba(79,70,229,0.5)]"/>}
 </Link>
 );
 };
 ...
 className="bg-white dark:bg-[#111827] p-8 md:p-10 rounded-[2.5rem] shadow-2xl dark:shadow-black/25 dark:shadow-black/30 border border-slate-100 dark:border-slate-700/50 dark:border-slate-700 flex flex-col items-center text-center max-w-sm w-full relative overflow-hidden"
 >
 <button 
 ...
 cartModal.type === 'success' ? 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-500 border-emerald-100 dark:border-emerald-500/20' : 'bg-rose-50 dark:bg-rose-500/10 text-rose-500 border-rose-100 dark:border-rose-500/20'
 }`}>
 ...
 <button onClick={() => setCartModal({ ...cartModal, isOpen: false })} className="w-full py-3.5 bg-slate-900 dark:bg-slate-600 hover:bg-slate-800 dark:hover:bg-indigo-600 text-white font-bold rounded-xl shadow-lg dark:shadow-black/20 flex items-center justify-center gap-2">
 Tutup
 </button>
 ) : (
 <>
 <button onClick={() => { setCartModal({ ...cartModal, isOpen: false }); router.push('/cart'); }} className="w-full py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg dark:shadow-black/20 shadow-indigo-200 dark:shadow-indigo-900/30 flex items-center justify-center gap-2">
 ...
 <button onClick={() => setCartModal({ ...cartModal, isOpen: false })} className="w-full py-3.5 bg-slate-900 dark:bg-slate-600 hover:bg-slate-800 dark:hover:bg-indigo-600 text-white font-bold rounded-xl shadow-lg dark:shadow-black/20 shadow-slate-200 dark:shadow-black/20 flex items-center justify-center gap-2">
 Tutup Peringatan
 </button>
 )}
 </div>
 ...
 <div className="fixed inset-0 z-[9999] bg-slate-900/60 dark:bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
 <motion.div initial={{ scale: 0.9, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} className="bg-white dark:bg-[#111827] p-8 md:p-10 rounded-[2.5rem] shadow-2xl dark:shadow-black/25 dark:shadow-black/30 border border-slate-100 dark:border-slate-700/50 dark:border-slate-700 flex flex-col items-center text-center max-w-sm w-full relative overflow-hidden">
 ...
 <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[9999] bg-white dark:bg-slate-800/60 dark:bg-slate-950/80 backdrop-blur-2xl flex flex-col items-center justify-center p-4">
 <motion.div initial={{ scale: 0.8, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} transition={{ type:"spring", bounce: 0.5, duration: 0.8 }} className="bg-white dark:bg-slate-800/90 p-10 md:p-14 rounded-[2.5rem] shadow-[0_30px_80px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_30px_80px_-15px_rgba(0,0,0,0.5)] border border-slate-200/50 dark:border-slate-700/300 flex flex-col items-center text-center max-w-sm w-full relative overflow-hidden backdrop-blur-md">
 ...
 <div className={`absolute -top-10 -right-10 w-32 h-32 rounded-full blur-3xl opacity-15 ${logoutState.type === 'success' ? 'bg-emerald-50 dark:bg-emerald-500' : 'bg-rose-50 dark:bg-rose-500'}`} />
 <div className={`w-24 h-24 rounded-full flex items-center justify-center mb-6 shadow-inner ${logoutState.type === 'success' ? 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-500 border border-emerald-100 dark:border-emerald-500/20' : 'bg-rose-50 dark:bg-rose-500/10 text-rose-500 border border-rose-100 dark:border-rose-500/20'}`}>
 ...
 <AnimatePresence>
 {isMobileMenuOpen && (
 <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setIsMobileMenuOpen(false)} className="fixed inset-0 bg-slate-900/20 dark:bg-black/50 backdrop-blur-sm z-40 lg:hidden"/>
 )}
 </AnimatePresence>
 ...
 <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-50 dark:bg-indigo-500/20 rounded-full blur-3xl -mr-10 -mt-10 transition-transform duration-500 group-hover:bg-indigo-50 dark:bg-indigo-500/30"></div>
 ...
 <header className="h-[72px] bg-white dark:bg-slate-800/60 dark:bg-slate-900/70 backdrop-blur-2xl border-b border-white dark:border-slate-700/50 flex items-center justify-between px-4 sm:px-5 md:px-10 sticky top-0 z-30 shadow-[0_4px_30px_rgba(0,0,0,0.02)] dark:shadow-none">
 ...
 className={`relative p-2.5 rounded-xl transition-transform duration-300 group/dm ${
 isDarkMode 
 ...
 <footer className="bg-white dark:bg-slate-800/300 dark:bg-slate-900/80 backdrop-blur-md border-t border-slate-200 dark:border-slate-700/50 mt-auto w-full z-10 relative">
 ...
 <div 
 className="relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full shadow-lg border border-slate-200/30 dark:border-slate-700/20 transition-colors"
 >
