...
export default function MyEventsClient() {
 ...
 <span className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 break-words text-center px-4">Menyinkronkan Ruang Belajar...</span>
 </div>
 );
 ...
 className="w-full bg-slate-50 dark:bg-[#111827] border border-slate-200 dark:border-slate-700/50 rounded-xl md:rounded-2xl py-3 pl-11 pr-4 text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 dark:text-slate-400 focus:bg-white dark:bg-[#111827] focus:outline-none focus:ring-4 focus:ring-indigo-500/10 dark:focus:ring-indigo-500/20 focus:border-indigo-400 dark:focus:border-indigo-500 transition-transform shadow-inner"
 />
 </div>

 <div className="flex w-full md:w-auto bg-slate-100 dark:bg-slate-700/50 p-1.5 rounded-xl md:rounded-2xl border border-slate-200 dark:border-slate-700/50 dark:border-slate-700 shrink-0 overflow-x-auto custom-scrollbar">
 {[
 ...
 className={`flex items-center justify-center gap-1.5 flex-1 md:flex-none px-4 md:px-5 py-2.5 text-[10px] md:text-xs font-bold uppercase tracking-wider rounded-lg md:rounded-xl transition-transform whitespace-nowrap relative ${
 statusFilter === type.id 
 ? 'text-indigo-700 dark:text-indigo-400 shadow-sm dark:shadow-black/10' 
 ...
 <h3 className="text-xl md:text-2xl font-black text-slate-900 dark:text-white mb-2 break-words w-full">Area Belajar Kosong</h3>
 <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400 mb-8 max-w-md leading-relaxed break-words w-full">
 ...
 {/* CONTENT CONTAINER */}
 <div className="p-4 md:p-5 flex-1 flex flex-col w-full min-w-0 bg-white dark:bg-[#111827]">
 <div className="flex items-center justify-between mb-3 min-w-0 w-full gap-2">
 <div className="flex items-center gap-1.5 min-w-0 bg-slate-50 dark:bg-[#111827] px-2.5 py-1 rounded-md border border-slate-100 dark:border-slate-700/50">
 <Briefcase size={10} className="text-slate-400 dark:text-slate-400 shrink-0"/>
 <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 truncate min-w-0 flex items-center gap-1">
 {organizerName}
 ...
 <h3 className={`text-base md:text-[17px] font-black leading-[1.3] mb-4 line-clamp-2 break-words w-full ${isPast ? 'text-slate-500 dark:text-slate-400' : 'text-slate-900 dark:text-white group-hover:text-indigo-700 dark:text-indigo-400'}`}>
 {reg.event?.title || 'Program Tidak Tersedia'}
 </h3>

 <div className="mt-auto pb-5 w-full min-w-0 grid grid-cols-2 gap-2">
 <div className="flex flex-col gap-1 min-w-0 border-r border-slate-100 dark:border-slate-700/50">
 <span className="flex items-center gap-1.5 text-[9px] font-black text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-1">
 <Calendar size={10} className="text-indigo-400"/> Tanggal
 </span>
 <span className="text-[11px] md:text-xs font-semibold text-slate-700 dark:text-slate-300 truncate w-full pr-2">
 ...
 <span className="text-[11px] md:text-xs font-semibold text-slate-700 dark:text-slate-300 truncate w-full">
 {reg.event?.venue || '-'}
 </span>
 </div>
 </div>

 <div className="pt-4 border-t border-slate-100 dark:border-slate-700/50 flex items-center justify-between gap-3 w-full min-w-0">
 <div className="flex flex-col min-w-0 shrink-0">
 <span className="flex items-center gap-1 text-[9px] font-black text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-0.5">
 <Tag size={10} className="text-amber-500"/> Nilai Tiket
 </span>
 <span className={`text-[13px] md:text-sm font-black truncate w-full ${isFree ? 'text-emerald-500' : 'text-slate-900 dark:text-white'}`}>
 ...
 className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-xs font-bold transition-transform group/btn min-w-0 ${
 isPast 
 ? 'bg-slate-100 dark:bg-slate-700/50 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-600 border border-slate-200 dark:border-slate-700/50 shadow-sm dark:shadow-black/10' 
 : 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 hover:bg-indigo-600 hover:text-white shadow-sm dark:shadow-black/10 border border-indigo-100 dark:border-indigo-500/20 hover:border-indigo-600'
 }`}
 >
 <Video size={14} className={isPast ? 'text-slate-500 dark:text-slate-400' : 'text-indigo-400 group-hover/btn:text-indigo-200'} />
