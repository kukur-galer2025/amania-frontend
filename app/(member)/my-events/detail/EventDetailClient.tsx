...
export default function EventDetailClient() {
  ...
  const handleRegister = () => {
    // 🔥 TOMBOL MENUJU CHECKOUT KEMBALI MENGGUNAKAN PARAMETER 🔥
                      ...
                      <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-slate-200 w-full min-w-0">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 w-full min-w-0">
                          {event.speakers.map((spk: any) => (
                            <div key={spk.id} className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-white hover:shadow-sm transition-all group min-w-0 w-full">
